...
- 输入参数：无
- 输出参数：code, message
- curl调用示例：curl -v -H "Accept: application/json" -X POST -d '{}' http://hotcat.dev/app_dev.php/api/v1/account/logout?token=2916f5b579f171214843c4ace26f3c15
...
- curl调用示例：curl -v -H "Accept: application/json" http://hotcat.dev/app_dev.php/api/v1/account?token=2916f5b579f171214843c4ace26f3c15
...
- 输出参数：code, message
- curl调用示例：curl -v -H "Accept: application/json" -H "Content-type: application/json" -X POST -d '{"oldPassword":"098f6bcd4621d373cade4e832627b4f6", "newPassword":"test123"}' http://hotcat.dev/app_dev.php/api/v1/account/changepassword?token=2916f5b579f171214843c4ace26f3c15
